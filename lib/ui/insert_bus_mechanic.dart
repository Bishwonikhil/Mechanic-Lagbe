...
class InsertBus extends StatefulWidget {
  const InsertBus({Key? key}) : super(key: key);

  @override
  State<InsertBus> createState() => _InsertBusState();
}

class _InsertBusState extends State<InsertBus> {
  CollectionReference users = FirebaseFirestore.instance.collection('Bus');
