...
class SearchCNG extends StatefulWidget {
  ...
  @override
  State<SearchCNG> createState() => _SearchCNGState();
}

class _SearchCNGState extends State<SearchCNG> {
  CollectionReference users = FirebaseFirestore.instance.collection('CNG');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection("CNG").snapshots(),
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (_) => NetworkGiffDialog(
                      image: Image.network(
                        'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/6555a238830641.577126a354b2e.gif',
                        fit: BoxFit.cover,
                      ),
                      title: Text(
                      ...
                      description: Text(
                          'I am a CNG mechanic.I am here for to serve you. Feel free to call me ' +
