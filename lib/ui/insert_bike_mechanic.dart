...
class InsertBike extends StatefulWidget {
  const InsertBike({Key? key}) : super(key: key);

  @override
  State<InsertBike> createState() => _InsertBikeState();
}

class _InsertBikeState extends State<InsertBike> {
  CollectionReference users = FirebaseFirestore.instance.collection('Bike');
